...
from competitor_sites_connector.api.utils.scrape_utils import _run_scrape_strategy
...
def test_scrape_url(site_url, scrape_method="Auto", product_limit=500, output_dir=None):
    ...
    Usage:
        bench --site stellar.brands execute competitor_sites_connector.api.utils.test_scrape.test_scrape_url \\
